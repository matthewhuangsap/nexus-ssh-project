...
public class RoleController extends BaseAction<Role> {
	...
	// TODO 瑕佸垱寤轰竴涓嚱鏁帮紝鏉ュ垱寤轰竴涓紶缁檆heckboxlist鐨勬暟缁�
	@SuppressWarnings("unchecked")
...
//		ActionContext.getContext().getSession().put("access_group_map",
//				access_group_map);
//		ActionContext.getContext().getSession().put("plugin_info", plugin_info);
//	}
...
//							"褰撳墠Action锛�%s涓殑鏂规硶锛�%s娉ㄩ噴鏈夎,鎵句笉鍒版潈闄�:[%s];", action_clazz
