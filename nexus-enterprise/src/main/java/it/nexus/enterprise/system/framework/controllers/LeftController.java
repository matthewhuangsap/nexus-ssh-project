...
public class LeftController extends BaseAction {
  ...
  private void checkMenuRole(Menu rootMenu, Map<String, Map<String, Long>> roles) {
    ...
    final Map<String, String> PLUGIN_S_INFO = PluginManager.getPluginSimpleInfo();
    System.out.println(PLUGIN_ACCESS_MAP);
    System.out.println(PLUGIN_S_INFO);
  ...
  private void checkRole(List<Element> menu_url_list, Map<String, Long> roles) {
    final Map<String, Map<String, Map<Long, String>>> plugin_map = PluginManager.getAccessGroupMap();
    final Map<String, String> plugin_info = PluginManager.getPluginSimpleInfo();
